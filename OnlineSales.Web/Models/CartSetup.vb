...
Partial Public Class CartSetup
    ...
    Public Property FAQpage As String
    Public Property AboutUsPage As String
    Public Property TermsConditionsPage As String
    Public Property ContactUsPage As String
