@ModelType OnlineSales.Web.EmailContentViewModel
                                ...
                                <div class="column" style="text-align: left;color: #000;font-size: 16px;line-height: 24px;font-family: Verdana,sans-serif;">
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            ...
                                            </p><p class="size-13" style="Margin-top: 20px;Margin-bottom: 0;font-size: 13px;line-height: 21px;" lang="x-size-13">
                                                <span style="color:#7a7a7a">
                                                    <strong>
                                                        NiftyCart.com (a Service of Listening Software, Inc.<br />
                                                        P.O. Box 532484<br />
                                                        Kihei, Hi 96753 USA)
                                                    </strong>
                                                </span>
                                            </p><p class="size-13" style="Margin-top: 20px;Margin-bottom: 0;font-size: 13px;line-height: 21px;" lang="x-size-13">&nbsp;</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
